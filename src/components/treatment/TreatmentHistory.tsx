      ...
      <div className="bg-neutral-900 p-6 rounded-3xl border border-neutral-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-1">
            Geçmişte ve halen kullanılan sistemik/biyolojik tedavilerin kronolojik kaydı.
          </p>
        </div>
      ...
      <div className="bg-neutral-900 p-6 rounded-3xl border border-neutral-800">
        <div className="relative space-y-6 before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-0.5 before:bg-neutral-800">
            ...
            return (
              <div key={entry.id} className="relative pl-12">
                ...
                <div className={`p-4 rounded-2xl border space-y-2 ${
                  ...
                  <p className="text-[11px] text-neutral-400">{entry.drugClass} • {entry.route}</p>
          ...
          {treatmentHistory.length === 0 && (
            <p className="text-xs text-neutral-500 pl-12">Henüz kayıtlı tedavi geçmişi bulunmuyor.</p>
          )}
        </div>
      </div>

      {/* Bilgilendirme Notu */}
      <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 text-xs text-neutral-400 flex items-start gap-2">
        <HelpCircle className="w-4 h-4 text-neutral-300 shrink-0 mt-0.5" />
